  ...
  var ParticlePanel = me.Renderable.extend({
    ...
    init: function() {
      ...
      this._super(me.Renderable, 'init', [
        0,
        me.video.renderer.getHeight() - 60,
        200,
        60
      ]);
    ...
    drawGraph: function(renderer) {
      ...
      var maxTime = 60,
        scale = height / maxTime,
        len = updateTimeSamples.length;
      var frameTimeLimit = 1000 / me.sys.fps,
        where = height - frameTimeLimit * scale;
    ...
    draw: function(renderer) {
      ...
      this.font.draw(
        renderer,
        'update: ' +
          this.updateTimeAvg.toFixed(2) +
          'ms / ' +
          this.frameUpdateTimeAvg.toFixed(2) +
          'ms',
        5,
        31
      );
      ...
      this.font.draw(
        renderer,
        'draw: ' +
          this.drawTimeAvg.toFixed(2) +
          'ms / ' +
          this.frameDrawTimeAvg.toFixed(2) +
          'ms',
        5,
        44
      );
